...
{
    public class StudentSingleDataMst
    {
        public IFormFile STUDENT_FILE { get; set; }
        public string ? STUDENT_FILE_URL { get; set; }
        public IFormFile FATHERS_FILE { get; set; }
        public string ? FATHERS_FILE_URL { get; set; }
        public IFormFile MOTHERS_FILE { get; set; }
        public string ? MOTHERS_FILE_URL { get; set; }
        public IFormFile GURDIAN_FILE { get; set; }
        public string ? GURDIAN_FILE_URL { get; set; }
        ...
        public decimal ? PARENTS_MON_INCOME { get; set; }
        ...
        public List<decimal>? EDUCATION_ID { get; set; }
        public List<string>? EXAM_NAME { get; set; }
        public List<string>? INSTITUTE { get; set; }
        public List<string>? PASSING_YEAR { get; set; }
        public List<string>? BOARD { get; set; }
        public List<string>? ROLL_NO { get; set; }
        public List<string>? REG_NO { get; set; }
